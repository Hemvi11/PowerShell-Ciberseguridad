"""
verificar_correo.py
Script principal para verificar si un correo ha sido comprometido en brechas de seguridad.
Usa las funciones definidas en funciones.py
"""
    ...
    if respuesta.status_code == 200:
        ...
        for i, brecha in enumerate(brechas[:3]):
            ...
            if detalle_resp.status_code == 200:
                ...
                logging.error(
                    f"No se pudo obtener detalles de {nombre}. Código: {detalle_resp.status_code}"
                )
            if i < 2:
                time.sleep(10)
